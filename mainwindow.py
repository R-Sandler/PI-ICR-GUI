...
class Ui_MainWindow(QtWidgets.QWidget):
    ...
    def setupUi(self, MainWindow):
        ...
        self.nPlus = QtWidgets.QPushButton(self.centralWidget)
        self.nPlus.setGeometry(860, 660, 20, 20)
        self.nPlus.setDefault(False)
        self.nPlus.setFlat(False)
        self.nPlus.setObjectName("nPlus")
        self.nMinus = QtWidgets.QPushButton(self.centralWidget)
        self.nMinus.setGeometry(890, 660, 20, 20)
        self.nMinus.setDefault(False)
        self.nMinus.setFlat(False)
        self.nMinus.setObjectName("nMinus")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.nPlus.setText(_translate("MainWindow", "+"))
        self.nMinus.setText(_translate("MainWindow", "-"))
