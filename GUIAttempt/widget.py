...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.horizontalLayout.addWidget(self.label,QtCore.Qt.AlignTop)
        self.EnterName = QtWidgets.QLineEdit(self.layoutWidget)
        self.EnterName.setObjectName("EnterName")
        self.horizontalLayout.addWidget(self.EnterName,QtCore.Qt.AlignTop)
        ...
        self.horizontalLayout.addWidget(self.EnterButton,QtCore.Qt.AlignTop)
        self.verticalLayout.addLayout(self.horizontalLayout,QtCore.Qt.AlignTop)
        ...
        self.verticalLayout.addWidget(self.lineEdit,QtCore.Qt.AlignTop)
